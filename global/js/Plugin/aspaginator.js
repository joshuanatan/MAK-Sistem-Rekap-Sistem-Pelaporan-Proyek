      ...
      value: function getDefaults() {
        return {
          ...
          components: {
            prev: {
              tpl: function tpl() {
                return "<li class=\"".concat(this.namespace, "-prev page-item\"><a class=\"page-link\" href=\"javascript:void(0)\" aria-label=\"Prev\"><span class=\"icon md-chevron-left\"></span></a></li>");
              }
            },
            next: {
              tpl: function tpl() {
                return "<li class=\"".concat(this.namespace, "-next page-item\"><a class=\"page-link\" href=\"javascript:void(0)\" aria-label=\"Next\"><span class=\"icon md-chevron-right\"></span></a></li>");
              }
            },
            lists: {
              tpl: function tpl() {
