...
CREATE TABLE `mstr_user` (
  ...
  `id_fk_user_level` int(11) NOT NULL,
...
INSERT INTO `mstr_user` (`id_pk_user`, `id_fk_user_level`, `user_username`, `user_password`, `user_email`, `user_telepon`, `user_status`, `user_tgl_create`, `user_tgl_update`, `user_tgl_delete`, `user_id_create`, `user_id_update`, `user_id_delete`) VALUES
(1, 1, 'erock', 'kjekf', 'erickgen@gmail.com', '123456789', 'nonaktif', '2021-04-11', '2021-04-11', '2021-04-11', 1, 1, 1),
