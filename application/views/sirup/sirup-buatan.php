...
<body class="animsition site-navbar-small ">
  ...
  <div class="page">
    <div class="page-header">
      <h1 class="page-title">Data SiRUP Buatan</h1>
      <ol class="breadcrumb">
...
<script>
  ...
  function reload_table() {
    var url = `<?php echo base_url(); ?>ws/sirup/get_data_creator?kolom_pengurutan=${kolom_pengurutan}&arah_kolom_pengurutan=${arah_kolom_pengurutan}&pencarian_phrase=${pencarian_phrase}&kolom_pencarian=${kolom_pencarian}&current_page=${current_page}`;
    $.ajax({
      url: url,
      type: "GET",
      dataType: "JSON",
