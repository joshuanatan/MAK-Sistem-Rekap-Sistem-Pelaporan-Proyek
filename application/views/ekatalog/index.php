...
<script id="script core">
  ...
  function reload_table() {
    var url = `<?php echo base_url(); ?>ws/ekatalog/get_data_system?kolom_pengurutan=${kolom_pengurutan}&arah_kolom_pengurutan=${arah_kolom_pengurutan}&pencarian_phrase=${pencarian_phrase}&kolom_pencarian=${kolom_pencarian}&current_page=${current_page}`;
    $.ajax({
      url: url,
      type: "GET",
      dataType: "JSON",
      success: function(respond) {
        ...
        for (var a = 0; a < respond["data"].length; a++) {
          ...
          <tr class = "ekatalog_row" id = "ekatalog_row${a}">
            ...
            <td>${respond["data"][a]["ekatalog_tgl_create"]}</td>
