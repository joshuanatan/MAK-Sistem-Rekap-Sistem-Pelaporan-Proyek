...
class Prospek extends CI_Controller{
  public function create(){
    ...
    $this->form_validation->set_rules("qty_produk","Quantity Produk","required");
    ...
    if($this->form_validation->run()){
      ...
      $last_id = $this->m_produk->insert_detail_prospek($nama_produk,$qty_produk,$keterangan_produk);
